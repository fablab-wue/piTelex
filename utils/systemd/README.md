## How To Install piTelex as a systemd service under linux

Service installation (tested on Raspbian buster, bookworm, trixie):

1. Make sure byobu and screen are installed:

   `sudo apt install byobu screen`

2. Adapt pitelex.service to configure 
...
> access on start. 
> (On Raspberry Pi with Raspbian 10 (buster), this requires
